...
auch in der Inaktivität liegen. Ferner wurden 4 Mitglieder 
ausgeschlossen, da sie die Mitgliedsbeiträge endgültig nicht entrichtet 
haben.

Im Laufe des Berichtszeitraum wurden 2 Mahnläufe durchgeführt, um 
...
Dies beinhaltet sowohl die unter \ref{sec:anschaffungen} beschriebenen 
...
Eine besonderes große Zuwendung gab es dabei von der 
...
Durch eine Spende (vgl. Abschnitt \ref{sec:iss-spende}) der Intershop 
Stiftung, war es uns möglich, einen Projektor (ugs. Beamer) für den 
Raum für Vorträge, Workshops u.s.w. anzuschaffen. Nach einer 
Marktstudie und Abstimmung im Plenum wurde sich dafür entschieden, für 
den Erwerb ausschließlich auf die Spende zurück zu greifen und einen 
Projektor des Types \texttt{LG PB60G }im Wert von 413\euro{} anzuschaffen. 
Dieser steht zur Benutzung in den Vereinsräumen bereit.
...
\begin{itemize}
    \item Repräsentation des Vereins nach Außen
    \item Vorstandstreffen
    \item Rechenschaftsbericht schreiben und Mitgliederversmmlung inhaltlich vorbereiten
    \item Schreiben von Förderanträgen
    \item Vereinspost bearbeiten
\end{itemize}
