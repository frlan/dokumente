...
Konrad hat sich mit folgenden beschäftigt:
\begin{itemize}
	\item ...
\end{itemize}
...
Felix hat sich mit folgenden beschäftigt:
...
Frank hat sich mit folgenden beschäftigt:
...
\begin{itemize}
	\item Vereinsfinanzen
		\begin{itemize}
			...
			\item 3 Berichte über Kassenstand
			\item Abstimmung mit dem Finanzamt bzgl. Gemeinnützigkeit
			\item Ausstellung von vereinzelten Zuwendungsbescheinigung
				  sowie Mitarbeit an einem Script zu vereinfachten
	...
	\item Mitgliederverwaltung
		\begin{itemize}
			...
			\item 2 Mahnläufe für säumige Mitglieder inkl.
		...
		\begin{itemize}
			...
			\item Betreung verschiedener regelmäßiger Veranstaltungen:
				\begin{itemize}
					...
					\item LPI-Lerngruppe
				\end{itemize}
			\item Unterstützung bei weiteren Veranstaltungen wie z.B. Vorbereitungen zu LNdW
		\end{itemize}
	\item Vorantreibung Ausstattung Werkstatt
		\begin{itemize}
			\item Elektrokkleinteile
			\item Labornetzteil
			\item Sortierboxen
	...
	\item Projekte
		...
		\end{itemize}
	\item Mitbetreung des Server; Pflege Inhalte auf \url{https://krautspace.de}
...
Im August 2015 läuft die aktuelle Vereinbarung mit den Darlehensgeber
für die Kaution der Vereinsräume in der Krautgasse 26 aus. In 2012
haben 5 Mann je 333\euro{} zinsfrei dem Verein zur Verfügung gestellt.
Wenn möglich sollten diese Darlehen früher aufgelöst werden -- dazu
...
Jena ist eine Stadt der Studenten. Dies spiegelt sich auch in einer relativ hohen Anzahl von Studenten und universitätsnahen Mitgliedern wieder. Da sowohl die Zeit der Studenten an der Universität, wie auch die der Dozenten und allgemein des wissenschaftlichen Mittelbaus begrenzt ist, ergibt sich für den Verein die Herausforderung, stärker als bei anderen Vereinen, die Fluktuation durch Wegzug und/oder Änderung der Lebensschwerpuntke entgegen zu wirken. Dazu müssen regelmäßig neue Mitglieder für den Verein gewonnen werden, um die Anzahl der Schulter stabil zu halten. Einher geht dies mit dem zusätzlichen Gewinnen von Fördermitgliedern.
