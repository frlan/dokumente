...
In diesem Zeitraum tätigte der Verein auch Ausgaben von gesamt \SI{10873,24}{\EUR} davon \SI{8596,92}{\EUR} im ideellen Bereich und \SI{2276,32}{\EUR} im Bereich des Zweckbetriebs.
...
Die Ausgaben in diesem Bereich und Zeitraum für den Krautspace an Miete, Internet, Abschläge für Strom und Nebenkosten Beträgt \SI{7799,92}{\EUR}, dieser Betrag berücksichtigt nicht die Gutschrift aus der Betriebskostenabrechnung da der Abrechnungszeitraum vor dem 16.\,November~2013 liegt.
...
Aus den Verkäufen ergaben sich Einnahmen von \SI{4066,30}{\EUR}, wobei für \SI{1914,85}{\EUR} Waren eingekauft worden.
Damit ergibt sich ein Überschuss von \SI{2151,45}{\EUR} die für Finanzierungen im Ideellen Bereich verwendet werden können.
